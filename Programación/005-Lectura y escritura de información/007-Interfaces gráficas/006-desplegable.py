...
desplegable = tk.StringVar(ventana)
desplegable.set("Selecciona una opción")  # Valor por defecto
opciones = ["Opción 1", "Opción 2", "Opción 3"]
menu_desplegable = tk.OptionMenu(ventana, desplegable, *opciones)
menu_desplegable.config(font=("Arial", 14), bg="lightgray", fg="black")
menu_desplegable.pack(pady=10)  # Añadir un espacio vertical
